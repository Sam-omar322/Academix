...
<div class="container py-5">
    ...
    <div class="text-center mb-4 pb-3 border-bottom">
        <h1 class="display-5 fw-bold">{{ __('استكشف جميع دوراتنا') }}</h1>
        <p class="lead text-muted">{{ __('ابحث عن الدورة المثالية لك من بين مجموعتنا الواسعة من العروض التعليمية.') }}</p>
    </div>
